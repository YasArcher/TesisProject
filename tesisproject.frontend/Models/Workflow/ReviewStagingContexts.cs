        ...
        private static readonly IReadOnlyDictionary<string, ReviewStagingContextDefinition> Definitions =
            new Dictionary<string, ReviewStagingContextDefinition>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["author-correction"] = new(
                    ...
                    PageTitle: "Corrección del envío",
                    PageHeading: "Corrección de registro devuelto",
                    PageEyebrow: "Corrección del autor",
                    PageSummary: "Espacio para revisar las observaciones de UODIDE, corregir los datos del envío y validarlo antes de reenviarlo.",
                    WorkspaceTitle: "Datos observados del envío",
                    WorkspaceDescription: "Corrige las filas señaladas y valida el envío. Cuando no queden observaciones, regresa al workflow para reenviarlo a UODIDE.",
                    AudienceLabel: "Autor",
                    AutoApproveAfterValidation: false,
                    ApprovalComment: string.Empty,
                    SuccessTitle: "Envío validado por el autor",
                    SuccessMessageFormat: "El envío {0} quedó validado. Puedes volver al seguimiento y reenviarlo a UODIDE.",
                    LoadingMessage: "Cargando el envío devuelto y preparando la corrección...",
                    LoadErrorPrefix: "No pude cargar la corrección del envío",
                    BatchPendingHint: "Pendiente de corrección",
                    BatchErrorHint: "Corregir observaciones",
                    BatchReadyHint: "Listo para reenviar",
                    BatchProcessedHint: "Procesado",
                    ValidationPendingMessage: "Voy a validar las correcciones del envío para confirmar si ya puede reenviarse a UODIDE.",
                    ValidationErrorPrefix: "No pude validar las correcciones del envío",
                    EmptyGuidanceTitle: "Abre un envío devuelto",
                    EmptyGuidance: "Abre esta vista desde un envío devuelto para corregir los datos observados por UODIDE.",
                    NoRowsGuidance: "Este envío no tiene filas disponibles para corrección.",
                    EmptySelectionTitle: "Sin envío seleccionado",
                    EmptySelectionMessage: "Abre esta corrección desde el seguimiento de envíos devueltos.",
                    PendingGuidanceTitle: "Corregir y validar",
                    PendingStatusLabel: "En corrección",
                    PendingGuidance: "Revisa las observaciones, corrige las filas necesarias y valida el envío antes de reenviarlo.",
                    InProgressGuidance: "Corrige la información observada y valida nuevamente para confirmar que no queden errores.",
                    HasErrorsGuidanceTitle: "Observaciones pendientes",
                    HasErrorsGuidance: "Corrige primero las observaciones marcadas. El envío solo debería reenviarse cuando la validación quede limpia.",
                    ValidatedGuidanceTitle: "Listo para reenviar",
                    ValidatedGuidance: "El envío ya no tiene observaciones de validación. Puedes regresar al seguimiento y reenviarlo a UODIDE.",
                    ReadyGuidanceTitle: "Reenviar a UODIDE",
                    CompletedGuidanceTitle: "Corrección completada",
                    EmptyStageLabel: "Sin envío",
                    LoadedStageLabel: "Cargado",
                    ProcessedStageLabel: "Procesado",
                    ValidatedStageLabel: "Listo para reenviar",
                    ErrorStageLabel: "Con observaciones",
                    OpeningStatusLabel: "Abriendo corrección",
                    OpeningStatusDetail: "Estoy cargando el envío devuelto para que puedas corregirlo.",
                    ValidatingStatusLabel: "Validando corrección",
                    ValidatingStatusDetail: "La validación está revisando los cambios realizados por el autor.",
                    ProcessingStatusLabel: "Procesando envío",
                    ProcessingStatusDetail: "El sistema está integrando el envío aprobado dentro de la base principal.",
                    OpeningOverlayTitle: "Abriendo corrección",
                    OpeningOverlayMessage: "Estoy preparando el envío devuelto para edición.",
                    ValidatingOverlayTitle: "Validando corrección",
                    ValidatingOverlayMessage: "Estoy validando las correcciones aplicadas al envío.",
                    ProcessingOverlayTitle: "Procesando envío",
                    ProcessingOverlayMessage: "Estoy integrando el envío aprobado dentro de la base principal.",
                    ValidatedStatusLabel: "Listo para reenviar",
                    ErrorStatusLabel: "Con observaciones",
                    ReadyStatusLabel: "Listo para reenviar")
            };
