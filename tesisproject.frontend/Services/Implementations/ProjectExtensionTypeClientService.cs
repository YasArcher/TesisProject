...
{
    public class ProjectExtensionTypeClientService : IProjectExtensionTypeClientService
    {
        private readonly IApiClient _api;
        private readonly string _baseUrl = "api/projectextensiontypes";

        public ProjectExtensionTypeClientService(IApiClient api)
            => _api = api;
        ...
        {
            // GET: api/projectextensiontypes?onlyActives=true
        ...
        public Task<HttpResponseWrapper<CatalogDetailDTO?>> GetByIdAsync(
            ...
            CancellationToken ct = default)
        {
            // GET: api/projectextensiontypes/{id}
        ...
        public Task<HttpResponseWrapper<List<KeyValueItemDTO>?>> GetKeyValuesAsync(
            ...
            CancellationToken ct = default)
        {
            // GET: api/projectextensiontypes/key-values?term=x&take=10
        ...
        public Task<HttpResponseWrapper<CatalogDetailDTO?>> CreateAsync(
            ...
            CancellationToken ct = default)
        {
            // POST: api/projectextensiontypes
            ...
            CancellationToken ct = default)
        {
            ...
            // PUT: api/projectextensiontypes/{id}
        ...
        public Task<HttpResponseWrapper<NoContent?>> DeleteAsync(
            ...
            CancellationToken ct = default)
        {
            // DELETE: api/projectextensiontypes/{id}
