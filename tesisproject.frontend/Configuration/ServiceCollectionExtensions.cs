...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAppApiClients(this IServiceCollection services, string apiBase)
    {
        ...
        services.AddScoped<IRegistrationWorkflowSettingsClient, RegistrationWorkflowSettingsClient>();
        ...
        services.AddScoped<IInstitutionalIntelligenceClient, InstitutionalIntelligenceClient>();
        services.AddScoped<InstitutionalReportingPageStateStore>();
