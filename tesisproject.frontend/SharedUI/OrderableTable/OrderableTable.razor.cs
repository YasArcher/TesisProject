...
namespace tesisproject.frontend.SharedUI.OrderableTable
{
    public partial class OrderableTable<TItem> : ComponentBase, IAsyncDisposable
    {
        ...
        [Parameter] public string HeaderClass { get; set; } = "bg-primary-subtle-solid";

        // Igual que TableBase
        [Parameter] public string HeaderCellClass { get; set; } = "px-4 py-3 text-left text-xs font-semibold text-primary uppercase tracking-wider select-none bg-primary-subtle-solid sticky top-0 z-20";
        ...
        [Parameter] public string HandleHeaderCellClass { get; set; } = "w-12 px-4 py-3 bg-primary-subtle-solid sticky top-0 z-20";
