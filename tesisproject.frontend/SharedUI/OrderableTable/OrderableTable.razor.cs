...
namespace tesisproject.frontend.SharedUI.OrderableTable
{
    public partial class OrderableTable<TItem> : ComponentBase, IAsyncDisposable
    {
        ...
        [Parameter] public string TableClass { get; set; } = "min-w-full divide-y divide-border";
        [Parameter] public string HeaderClass { get; set; } = "bg-primary-subtle sticky top-0 z-10";

        // Igual que TableBase
        [Parameter]
        public string HeaderCellClass { get; set; } = "px-4 py-3 text-left text-xs font-semibold text-primary uppercase tracking-wider select-none";
        ...
        [Parameter] public string HandleHeaderCellClass { get; set; } = "w-12 px-4 py-3";
