...
namespace tesisproject.backend.Controllers
{
    ...
    public class GroupsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<List<ResolvedUserProfileDTO>>>> GetExternalUsers(
            int groupId,
            CancellationToken ct)
        ...
        public async Task<ActionResult<ApiResponse<List<ResolvedUserProfileDTO>>>> GetAllExternalUsers(
            CancellationToken ct)
        ...
        public async Task<ActionResult<ApiResponse<ResolvedUserProfileDTO>>> GetExternalUserByAspNetId(
            int userId,
            CancellationToken ct)
        ...
        public async Task<ActionResult<ApiResponse<ResolvedUserProfileDTO>>> GetExternalUserByEmail(
