...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    [ApiController]
    [Route("api/producttypedesign")]
    public sealed class UnifiedProductTypeDesignController : ControllerBase
    {
        private readonly IUnifiedProductTypeDesignService _service;

        public UnifiedProductTypeDesignController(IUnifiedProductTypeDesignService service)
            => _service = service;
