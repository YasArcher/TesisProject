...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    public class UnifiedConvocationsController : ControllerBase
    {
        private readonly IUnifiedConvocationService _service;

        public UnifiedConvocationsController(IUnifiedConvocationService service) => _service = service;
