...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    public class UnifiedInstitutionsController : ControllerBase
    {
        private readonly IUnifiedInstitutionService _service;

        public UnifiedInstitutionsController(IUnifiedInstitutionService service)
        {
            _service = service;
        }
