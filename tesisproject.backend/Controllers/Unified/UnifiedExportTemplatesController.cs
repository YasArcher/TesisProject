...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    [ApiController]
    [Route("api/exporttemplates")]
    public class UnifiedExportTemplatesController : ControllerBase
    {
        private readonly IUnifiedExportTemplateService _service;
        private readonly IUnifiedMatrixTemplateExcelExportService _matrixTemplateExcelService;

        public UnifiedExportTemplatesController(
            IUnifiedExportTemplateService service,
            IUnifiedMatrixTemplateExcelExportService matrixTemplateExcelService)
        {
            _service = service;
