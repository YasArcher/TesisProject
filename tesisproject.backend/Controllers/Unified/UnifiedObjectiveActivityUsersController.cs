...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    [ApiController]
    [Route("api/objectiveactivityusers")]
    public class UnifiedObjectiveActivityUsersController : ControllerBase
    {
        private readonly IUnifiedObjectiveActivityUserService _service;

        public UnifiedObjectiveActivityUsersController(IUnifiedObjectiveActivityUserService service)
            => _service = service;
