...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    public class UnifiedProjectObjectivesController : ControllerBase
    {
        private readonly IUnifiedProjectObjectiveService _service;

        public UnifiedProjectObjectivesController(IUnifiedProjectObjectiveService service)
            => _service = service;

        // GET: api/projectobjectives/by-project/{projectId}
        // 👉 Listado "ligero" (sin actividades)
        [HttpGet("by-project/{projectId:int}")]
        public async Task<ActionResult<ServiceResult<IReadOnlyList<ProjectObjectiveListItemDTO>>>> GetByProject(
            int projectId,
        ...
        public async Task<ActionResult<ServiceResult<IReadOnlyList<ProjectObjectiveWithActivitiesDTO>>>> GetByProjectWithActivities(
            int projectId,
            CancellationToken ct = default)
        ...
        public async Task<ActionResult<ServiceResult<IReadOnlyList<ProjectObjectiveWithActivitiesDTO>>>> GetByProjectWithActivitiesByVisit(
            int projectId,
            int visitId,
            CancellationToken ct = default)
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<ServiceResult<ProjectObjectiveDetailDTO>>> GetById(
            int id,
            CancellationToken ct = default)
        ...
        [HttpPost]
        public async Task<ActionResult<ServiceResult<ProjectObjectiveDetailDTO>>> Create(
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<ServiceResult<ProjectObjectiveDetailDTO>>> Update(
            int id,
