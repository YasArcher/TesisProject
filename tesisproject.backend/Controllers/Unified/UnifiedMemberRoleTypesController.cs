...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    [ApiController]
    [Route("api/memberroletypes")]
    public class UnifiedMemberRoleTypesController : ControllerBase
    {
        private readonly IUnifiedMemberRoleTypeService _service;

        public UnifiedMemberRoleTypesController(IUnifiedMemberRoleTypeService service)
            => _service = service;
