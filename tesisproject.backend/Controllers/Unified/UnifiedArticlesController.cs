...
namespace tesisproject.backend.Controllers.Unified
{
    [ApiController]
    [Route("api/articles")]
    public sealed class UnifiedArticlesController : ControllerBase
    {
        private readonly IUnifiedArticleQueryService _service;
        private readonly IUnifiedArticleRegistrationCommandService _registrationService;
        private readonly ArticlesModuleOptions _options;

        public UnifiedArticlesController(
            IUnifiedArticleQueryService service,
            IUnifiedArticleRegistrationCommandService registrationService,
