...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    public sealed class UnifiedProductAttributesController : ControllerBase
    {
        private readonly IUnifiedProductAttributeService _service;

        public UnifiedProductAttributesController(IUnifiedProductAttributeService service)
            => _service = service;
