...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    public class UnifiedBudgetsController : ControllerBase
    {
        private readonly IUnifiedBudgetService _service;

        public UnifiedBudgetsController(IUnifiedBudgetService service) => _service = service;
