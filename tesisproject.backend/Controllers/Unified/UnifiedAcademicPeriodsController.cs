...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    [ApiController]
    [Route("api/academicperiods")]
    public class UnifiedAcademicPeriodsController : ControllerBase
    {
        private readonly IExternalPeriodsClient _service;

        public UnifiedAcademicPeriodsController(IExternalPeriodsClient service)
        {
            _service = service;
        }
