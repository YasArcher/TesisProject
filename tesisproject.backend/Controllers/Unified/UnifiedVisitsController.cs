...
namespace tesisproject.backend.Controllers.Unified
{
    ...
    [ApiController]
    [Route("api/visits")]
    public class UnifiedVisitsController : ControllerBase
    {
        private readonly IUnifiedVisitService _service;

        public UnifiedVisitsController(IUnifiedVisitService service) => _service = service;
