...
namespace tesisproject.backend.Migrations
{
    ...
    [Migration("20260903181250_AddProjectFacultyHistory")]
    partial class AddProjectFacultyHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Catalogs.ProjectOriginType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.AppConfiguration", b =>
                {
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.FacultyScope", b =>
                {
                    ...
                    b.ToTable("FacultyScopes");
                });

            modelBuilder.Entity("tesisproject.shared.Entities.Core.FacultyScopeFaculty", b =>
                {
                    b.Property<int>("FacultyScopeId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("FacultyScopeFaculties");
                });
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.ProjectDocument", b =>
                {
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.ProjectFacultyHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectFacultyHistories");
                });
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.UserFacultyScopeAssignment", b =>
                {
                    ...
                    b.ToTable("UserFacultyScopeAssignments");
                });
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Export.ExportTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Export.ExportTemplateColumn", b =>
                {
                    ...
                    b.ToTable("ExportTemplateColumns");
                });
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.FacultyScopeFaculty", b =>
                {
                    b.HasOne("tesisproject.shared.Entities.Core.FacultyScope", "FacultyScope")
                        .WithMany("Faculties")
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.Project", b =>
                {
                    ...
                    b.HasOne("tesisproject.shared.Entities.Catalogs.ProjectOriginType", "ProjectOriginType")
                        .WithMany()
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Core.UserFacultyScopeAssignment", b =>
                {
                    ...
                    b.HasOne("tesisproject.shared.Entities.Auth.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("tesisproject.shared.Entities.Export.ExportTemplateColumn", b =>
                {
                    ...
                    b.HasOne("tesisproject.shared.Entities.Export.ExportTemplate", "Template")
                        .WithMany("Columns")
