...
namespace tesisproject.backend.Services.Interfaces
{
    ...
    Task<BulkImportActionResultDto> CreateBatchFromMatrixAsync(RegistrationMatrixDetailDto matrix, bool validateAfterCreate, bool useAuthorWorkflow, string? userId, IReadOnlyList<RegistrationMatrixRowParticipantDto>? rowParticipants = null, CancellationToken ct = default);
