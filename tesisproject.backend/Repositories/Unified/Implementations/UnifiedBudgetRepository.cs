...
{
    public class UnifiedBudgetRepository : IUnifiedBudgetRepository
    {
        private readonly UnifiedDideDbContext _ctx;
        private readonly DbSet<Budget> _set;

        public UnifiedBudgetRepository(UnifiedDideDbContext ctx)
        {
            _ctx = ctx;
