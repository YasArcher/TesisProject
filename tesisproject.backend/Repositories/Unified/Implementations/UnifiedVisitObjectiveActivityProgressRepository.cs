...
{
    public class UnifiedVisitObjectiveActivityProgressRepository
        : GenericRepository<VisitObjectiveActivityProgress>, IUnifiedVisitObjectiveActivityProgressRepository
    {
        public UnifiedVisitObjectiveActivityProgressRepository(UnifiedDideDbContext ctx) : base(ctx) { }
