...
{
    public class UnifiedProjectObjectiveRepository
        : GenericRepository<ProjectObjective>, IUnifiedProjectObjectiveRepository
    {
        public UnifiedProjectObjectiveRepository(UnifiedDideDbContext ctx) : base(ctx) { }
