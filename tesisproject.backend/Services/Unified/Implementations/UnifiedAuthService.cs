...
namespace tesisproject.backend.Services.Unified.Implementations
{
    public class UnifiedAuthService : IUnifiedAuthService
    {
        ...
        private readonly IUnifiedRefreshTokenService _refreshTokens;
        private readonly IUnifiedAppUserService _appUserRegistration;

        public UnifiedAuthService(
            UserManager<IdentityUser<int>> userManager,
            SignInManager<IdentityUser<int>> signInManager,
            ITokenService tokenService,
            IUnifiedRefreshTokenService refreshTokens,
            IUnifiedAppUserService appUserRegistration)
        {
