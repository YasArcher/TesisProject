...
{
    public class UnifiedDocumentRecognitionService : IUnifiedDocumentRecognitionService
    {
        private readonly ILogger<IUnifiedDocumentRecognitionService> _logger;
        ...
        public UnifiedDocumentRecognitionService(
            ILogger<IUnifiedDocumentRecognitionService> logger,
            ...
            IList<ResearcherInfo> researchers)
        {
            ...
            foreach (var r in researchers)
            {
                ...
                if (bestRoleId.HasValue && bestScore >= _opt.MemberRoleSimilarityThreshold)
                {
                    ...
                    r.RoleName = bestRoleName!; // Legacy transport permits an unresolved display name.
                }
                else
                {
                    _logger.LogWarning(
