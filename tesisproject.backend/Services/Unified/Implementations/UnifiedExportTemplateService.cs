...
{
    public class UnifiedExportTemplateService : IUnifiedExportTemplateService
    {
        ...
        private readonly ILogger<UnifiedExportTemplateService> _logger;

        private IUnifiedExportFieldRepository Fields => _uow.ExportFields;
        private IUnifiedExportTemplateRepository Templates => _uow.ExportTemplates;
        private IUnifiedExportTemplateColumnRepository Columns => _uow.ExportTemplateColumns;

        public UnifiedExportTemplateService(IUnifiedUnitOfWork uow, ILogger<UnifiedExportTemplateService> logger)
        {
            _uow = uow;
            _logger = logger;
        }
            ...
            CancellationToken ct)
        {
            ...
            // Build the complete detached aggregate before adding it to the context.
