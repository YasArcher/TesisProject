...
namespace tesisproject.backend.Services.Unified.Implementations
{
    ...
    /// - NameOverride
    /// </summary>
    public class UnifiedMatrixTemplateExcelExportService : IUnifiedMatrixTemplateExcelExportService
    {
        ...
        private readonly IUnifiedExportTemplateService _templateService;
        private readonly ILogger<UnifiedMatrixTemplateExcelExportService> _logger;

        public UnifiedMatrixTemplateExcelExportService(
            IUnifiedProjectFlatReportService flatService,
            IUnifiedResearchCategoryService categoryService,
            IUnifiedExportTemplateService templateService,
            ILogger<UnifiedMatrixTemplateExcelExportService> logger)
        {
        ...
        private static IEnumerable<ColumnDef> GetBaseColumns()
        {
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.ProjectCode ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.ProjectName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.ProjectTypeName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.ProjectStateName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Header = "Convocatoria",
                Selector = p => p.ConvocationName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Header = "% de ejecución",
                Selector = p => p.ExecutionPercentage?.ToString("N2") ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Header = "Facultad",
                Selector = p => p.FacultyName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.CoordinatorName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.CoordinatorEmail ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.CoordinatorPhone ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.SubrogantName ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.SubrogantEmail ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
            ...
            list.Add(new ColumnDef
            {
                ...
                Selector = p => p.SubrogantPhone ?? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder
            });
        ...
        private static string ResolveObjetivosBundle(ProjectFlatReportDTO project)
        {
            ...
            return lines.Count == 0 ? ErrorMessages.UnifiedLegacy.MatrixExcelExportService_EmptyPlaceholder : string.Join(Environment.NewLine, lines);
        }
