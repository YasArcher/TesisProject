...
{
    public class UnifiedConvocationService : IUnifiedConvocationService
    {
        ...
        public UnifiedConvocationService(IUnifiedUnitOfWork uow) => _uow = uow;
            ...
            CancellationToken ct = default)
        {
            try
            {
                ...
                // Complete reads before staging the new active row or changing tracked rows.
                var active = await _uow.Convocations.Query(asNoTracking: false)
