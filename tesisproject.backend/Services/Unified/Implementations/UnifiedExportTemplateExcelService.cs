...
{
    public class UnifiedExportTemplateExcelService : IUnifiedExportTemplateExcelService
    {
        private readonly IUnifiedProjectFlatReportService _flatService;
        private readonly ILogger<UnifiedExportTemplateExcelService> _logger;
        ...
        public UnifiedExportTemplateExcelService(
            IUnifiedProjectFlatReportService flatService,
            ILogger<UnifiedExportTemplateExcelService> logger)
        {
