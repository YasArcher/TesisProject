...
{
    public interface IUnifiedVisitService
    {
        ...
        Task<ServiceResult<IReadOnlyList<VisitPlannedForExecutionListDTO>>> ListPlannedForExecutionAsync(DateOnly? executionDate = null, CancellationToken ct = default);
