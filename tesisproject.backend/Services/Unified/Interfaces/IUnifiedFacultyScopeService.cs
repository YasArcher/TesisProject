...
{
    public interface IUnifiedFacultyScopeService
    {
        ...
        Task<ServiceResult<FacultyScopeResponseDTO>> CreateAsync(UnifiedCreateFacultyScopeRequestDTO request, CancellationToken ct = default);
        ...
        Task<ServiceResult<FacultyScopeResponseDTO>> SetFacultiesAsync(int facultyScopeId, UnifiedSetFacultyScopeFacultiesRequestDTO request, CancellationToken ct = default);
