...
{
    public class ProjectsDwContext : DbContext
    {
        public ProjectsDwContext(DbContextOptions<ProjectsDwContext> options) : base(options) { }
        ...
        public DbSet<BridgeProductAuthor> BridgeProductAuthors => Set<BridgeProductAuthor>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasDefaultSchema("ProjectsDW");
        ...
        private static void ConfigureDimensions(ModelBuilder modelBuilder)
        {
            ...
            {
                b.HasKey(a => a.AuthorKey);
                b.HasIndex(a => a.AuthorId).IsUnique();
                b.HasIndex(a => a.IsInstitutional);
                b.HasIndex(a => a.AppUserId);
                b.HasIndex(a => a.IdAsp);
                b.HasIndex(a => a.ExternalResearcherId);
                b.Property(a => a.ExternalFullName).HasMaxLength(150);
                b.Property(a => a.Orcid).HasMaxLength(50);
            });

            modelBuilder.Entity<DimJournal>(b =>
            {
                b.HasKey(j => j.JournalKey);
                b.Property(j => j.Name).HasMaxLength(450).IsRequired();
                b.HasIndex(j => j.Name).IsUnique();
                b.ToTable("DimJournals", "ProjectsDW", table => table.HasCheckConstraint(
        ...
        private static void ConfigureFacts(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FactProduct>(b =>
            {
                ...
                b.HasIndex(f => f.JournalKey);
                b.HasIndex(f => f.PublicationYear);
                b.Property(f => f.Title).HasMaxLength(1024).IsRequired();
                ...
                b.HasOne(f => f.Journal)
                 .WithMany(j => j.Products)
                 .HasForeignKey(f => f.JournalKey)
                 .OnDelete(DeleteBehavior.NoAction);
            });
        ...
        private static void ConfigureBridges(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BridgeProductAuthor>(b =>
            {
                b.HasKey(x => x.BridgeProductAuthorId);
                b.HasIndex(x => x.ProductAuthorId).IsUnique();
                b.HasIndex(x => new { x.FactProductId, x.AuthorKey }).IsUnique();
                ...
                b.HasOne(x => x.Product)
                 ...
                 .HasForeignKey(x => x.FactProductId)
                 .OnDelete(DeleteBehavior.NoAction);

                b.HasOne(x => x.Author)
                 .WithMany(a => a.ProductLinks)
